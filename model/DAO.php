...
class DAO{
  ...
  private $GET_PRODUCTS_BY_SUBCATEGORY_ID="SELECT * FROM `products` WHERE subcategory_id=?";
	...
	public function getCategoriesAndSubcategories(){
		...
		$statement =$this->db->prepare($this->GET_CATEGORIES_AND_SUBCATEGORIES);
	...
	public function getProductsBySubcategoryId($subId) {

		$statement = $this->db->prepare($this->GET_PRODUCTS_BY_SUBCATEGORY_ID);
